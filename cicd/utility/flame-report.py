...
##	Purpose: Summarize the newest zuid profiler flamegraph - self-time
...
##	Subsystem buckets for THIS app, keyed on function-name substrings. An
##	identifier is built by hashing or drawing bytes, converting them to the
##	output base, and fitting the result to a fixed symbol count - so self-time
