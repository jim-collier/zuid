...
- State factually that your product works with, is built on, is compatible with, or is derived from ZUID (e.g. "Foo, a ZUID fork", "powered by ZUID"), provided the statement is true and your own name is the prominent one.
...
If you distribute a modified version, you must remove or replace the Marks in the name, logo, and user-facing branding. You may - and we encourage you to - state plainly that your version is derived from ZUID. Do not use the Marks in a way that could lead users to attribute your changes to us.
...
- Include an attribution such as: "ZUID is a trademark of Jim Collier."
